...
namespace Delopgaveprojekt_ITONK_F20_Gruppe3.Controllers
{
    public class VaerktoejskassesController : Controller
    {
        ...
        public VaerktoejskassesController(AppDbContext.AppDbContext context)
        {
            _context = context;
        }
        ...
        {
            return View(await _context.Vaerktoejskasser.ToListAsync());
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var vaerktoejskasse = await _context.Vaerktoejskasser
